<div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right">
        <li><a class="dropdown-item" href="{{ route('issue.edit', $item) }}">Edit</a></li>
        <li><a class="dropdown-item" href="{{ route('issue.show', $item) }}">View</a></li>
...
<form method="POST" action="{{ route('issue.destroy', [$item]) }}" id="delete-form-{{ $item->id }}"
    style="display: none;">
    @csrf
    @method('DELETE')
</form>
